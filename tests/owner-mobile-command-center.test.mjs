...
test("owner command center is packaged and its external script parses", async () => {
  ...
  for (const route of ["owner", "briefs", "schedule", "fan-inbox", "activity", "notifications", "feed", "sites", "push"]) {
...
test("route and dropdown persona changes update the companion selection", async () => {
  ...
  assert.match(html, /mobile-owner-workflow\.js\?v=20260925-1/);
  assert.match(html, /owner-app\.js\?v=20260924-2/);
});
