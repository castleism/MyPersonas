...
| 16 | Founder or persona identity collision | Followers cannot tell who speaks; founder history appears in Akiko's first person; a retired host (formerly Brother Kāruṇya) is reintroduced; cross-persona reposts blur ownership | Separate bios, source labels, account maps, canon ledger; Karunya remains stripped; no identical cross-persona reposting | Owner approval for founder stories or cross-persona collaboration. Do not restore Karunya as a current Being Tea Co host. | One public lived-experience misattribution or unresolved identity complaint | Pause affected content, correct attribution visibly, separate profiles/archives, and update the canon ledger |
